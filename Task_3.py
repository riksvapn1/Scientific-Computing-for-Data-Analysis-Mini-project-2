...
for idx, k in enumerate(k_values): 
    ...
    print(f"k = {k:2d}   Overall accuracy: {overall_acc*100:.2f}%") # overall acc for a set num of k, for all digits
    # for every k, calc the acc for every digit aswell
    for d in range(10):
        mask = (test_labels == d)                     
